...
func main() {
	...
	fmt.Printf("The unread byte of the buffer: %v\n",unreadBytes)
	fmt.Println()
	...
	fmt.Println("The next bytes of the buffer: %v\n",nextBytes)
	fmt.Println()
	...
	value = byte('X')
	fmt.Println("Set a byte in the next bytes to %v ...\n",value)
